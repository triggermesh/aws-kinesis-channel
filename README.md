...
This repository implements a simple controller for watching Channel resources as
...
* How to register a new custom resource (custom resource type) of type `Channel` using a CustomResourceDefinition.
* How to create/get/list instances of your new resource type `Channel`.
...
# create a custom resource of type Channel
