...
// IsControlled determines if the aws-kinesis Channel Controller should control (and therefore
...
// ClusterChannelProvisioner. This Controller only handles aws-kinesis channels.
