...
const (
	...
	controllerAgentName = "aws-kinesis-clusterchannelprovisioner-controller"
)

// ProvideController returns a Controller that represents the aws-kinesis channel Provisioner. It
...
func ProvideController(mgr manager.Manager, logger *zap.Logger) (controller.Controller, error) {
	...
	// Setup a new controller to Reconcile ClusterChannelProvisioners that are aws-kinesis channels.
	r := &reconciler{
