...
import (
	...
	fake "github.com/triggermesh/aws-kinesis-channel/pkg/client/clientset/internalclientset/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/aws-kinesis-channel/pkg/client/clientset/internalclientset/fake.Clientset from context.")
	}
