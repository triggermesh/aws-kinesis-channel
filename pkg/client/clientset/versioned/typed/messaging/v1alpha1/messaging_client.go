...
import (
	...
	"github.com/triggermesh/aws-kinesis-channel/pkg/client/clientset/versioned/scheme"
...
type MessagingV1alpha1Interface interface {
	...
	KinesisChannelsGetter
}

// MessagingV1alpha1Client is used to interact with features provided by the messaging.triggermesh.dev group.
type MessagingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MessagingV1alpha1Client) KinesisChannels(namespace string) KinesisChannelInterface {
	return newKinesisChannels(c, namespace)
}
