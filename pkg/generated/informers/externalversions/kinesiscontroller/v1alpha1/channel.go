...
import (
	...
	kinesiscontrollerv1alpha1 "github.com/triggermesh/aws-kinesis-provisioner/pkg/apis/kinesiscontroller/v1alpha1"
	versioned "github.com/triggermesh/aws-kinesis-provisioner/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/triggermesh/aws-kinesis-provisioner/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/triggermesh/aws-kinesis-provisioner/pkg/generated/listers/kinesiscontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KinesiscontrollerV1alpha1().Channels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KinesiscontrollerV1alpha1().Channels(namespace).Watch(options)
			},
		},
		&kinesiscontrollerv1alpha1.Channel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *channelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kinesiscontrollerv1alpha1.Channel{}, f.defaultInformer)
}
