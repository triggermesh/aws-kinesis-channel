...
import (
	...
	scheme "github.com/triggermesh/aws-kinesis-provisioner/pkg/generated/clientset/versioned/scheme"
...
func newChannels(c *KinesiscontrollerV1alpha1Client, namespace string) *channels {
	return &channels{
		client: c.RESTClient(),
		ns:     namespace,
	}
