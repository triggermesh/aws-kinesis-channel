...
type FakeChannels struct {
	Fake *FakeKinesiscontrollerV1alpha1
	ns   string
}

var channelsResource = schema.GroupVersionResource{Group: "kinesiscontroller.triggermesh.dev", Version: "v1alpha1", Resource: "channels"}

var channelsKind = schema.GroupVersionKind{Group: "kinesiscontroller.triggermesh.dev", Version: "v1alpha1", Kind: "Channel"}
